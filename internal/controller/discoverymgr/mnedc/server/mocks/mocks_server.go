...
// Source: src/controller/discoverymgr/mnedc/server/server.go
...
import (
	...
	server_go "github.com/lf-edge/edge-home-orchestration-go/internal/controller/discoverymgr/mnedc/server"
	net "net"
	reflect "reflect"
)
...
func (m *MockMNEDCServer) CreateServer(arg0, arg1 string, arg2 bool, arg3 string) (*server_go.Server, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateServer", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*server_go.Server)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateServer indicates an expected call of CreateServer
func (mr *MockMNEDCServerMockRecorder) CreateServer(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateServer", reflect.TypeOf((*MockMNEDCServer)(nil).CreateServer), arg0, arg1, arg2, arg3)
}
...
func (m *MockMNEDCServer) Route(arg0 *server_go.NetPacket) {
	m.ctrl.T.Helper()
...
func (m *MockMNEDCServer) GetClientIPMap() map[string]server_go.IPTypes {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClientIPMap")
	ret0, _ := ret[0].(map[string]server_go.IPTypes)
	return ret0
}
